...
@Component({
    ...
    template: `<div class="layout-wrapper" [ngClass]="containerClass">
        ...
        <div class="layout-main-container" [class.layout-main-container-full]="isTableExpanded" [style.marginLeft]="!isTableExpanded && layoutService.layoutConfig().menuMode === 'static' ? '17rem' : '0'">
...
export class AppLayout implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.tableExpansionSubscription = this.tableStateService.isTableExpanded$.subscribe(
            (expanded) => {
